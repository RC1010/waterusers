...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $insert_sql = "INSERT INTO customer_orders (customer_id, quantity_ordered, created_by, created_at, updated_at)
               VALUES (:customer_id, :quantity_ordered, :created_by, :created_at, :updated_at)";
...
$orders_sql = "SELECT co.id AS order_id, c.first_name, c.last_name, c.number, co.quantity_ordered, co.created_at
