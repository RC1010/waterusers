...
$sql = "SELECT c.first_name, c.last_name, c.address, c.number, co.quantity_ordered, co.amount, co.created_at, co.updated_at, 
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <form id="editOrderForm" method="POST" action="./database/update-order.php">
                ...
                <div class="form-group">
                    <label for="editAmount">Amount Ordered</label>
